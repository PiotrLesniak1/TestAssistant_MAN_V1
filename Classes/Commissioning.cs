...
namespace TestAssistant.Classes
{
    ...
    internal class Commissioning : Test_Template
    {
        ...
        public Commissioning(Terminal TerminalMAIN, Terminal TerminalBOOT) : base(TerminalMAIN, TerminalBOOT, instructions)
        {
                            ...
                            if (CheckBootTerminal(CurrentInstruction.DesiredOutput))
                            {
                                ...
                                if (successful)
                                {
                                    if (!CurrentInstruction.isSecondLocation)
                                    {
                                        ...
                                        AddTestPointOutcome("Commission", "PASS");
                                    }
                            ...
                            if (CheckBootTerminal(CurrentInstruction.DesiredOutput))
                            {
                                switch (CurrentInstruction.DesiredOutput)
                                {
                                    case "Looking for file '/mlo_boot'":
                                        CurrentInstruction.CheckCompleted = HasFileBeenFound(CurrentInstruction.DesiredOutput, "Commission");
                                        break;
        ...
        public override void Reset_Test()
        {
            ...
            _ = SaveTerminalLog("Commissioning");
        }
